    ...
    <div class="container" style="background-color: #ececec">
        <div class="d-flex" style="margin-top: 20px">
            <div style="width: 960px; max-height: auto; background-color: white; margin-bottom: 50px">
                <img style="position: absolute;margin-left: 40px ;margin-top: 220px ;width: 160px;height: 160px ;border-radius: 50%" src="<?= $user['image_profile']?>" alt="avatar">
                ...
                <div class="">
                    ...
                    <div class="card-body">
                        <blockquote class="blockquote mb-0">
                            <p>Все что мы знаем о вас:</p>
                            <footer class="blockquote-footer">Ваш возраст:<cite title="Source Title"> <?= $user['age']?></cite></footer>
                            <footer class="blockquote-footer">Расскажите о ваших увлечениях:<cite title="Source Title"> <?= $user['about_user']?></cite></footer>

                            <? if ($user['user_group'] === 2): ?>
                                <footer class="blockquote-footer">Вы являетесь Главным Администратором онлайн кинотеатра</footer>
                            <? else: ?>
                                <footer class="blockquote-footer">Вы являетесь Гостем нашего онлайн кинотеатра</footer>
                            <? endif; ?>
                        </blockquote>
                    </div>
                </div>
