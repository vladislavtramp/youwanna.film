    ...
    <div class="container" style="background-color: #ececec">
        <div class="d-flex" style="margin-top: 20px">
            <div style="width: 960px; max-height: auto; background-color: white; margin-bottom: 50px">
                <table class="table">
                    <div style="width: 960px; height: 100px; background-color: #f5f5f5">
                        <div class="d-flex" style="margin-left: 15px">
                            <a style="margin-top: 33px;font-size: 14px; text-decoration: none;" href="/profile">назад</a>
                            <h2 style="margin-top: 20px;margin-left: 20px">Список Аниме</h2>
                        </div>
                        <p style="margin-left: 15px">Все </p>
                        <tr></tr>
                    </div>
                    <thead>
                    <tr>
                    ...
                    <tbody>
                    <? $counter = 1; foreach ($animes as $anime):?>

                    <tr>
                        <th scope="row"><? echo $counter++?></th>
                        <td>
                            <div class="d-flex">
                                <a href="/anime/<?= $anime['id']?>"><img style="width: 50px; height: 75px" src="<?= $anime['image_url'] ?>"></a>
                                <div class="" style="margin-left: 15px">
                                    <a href="/anime/<?= $anime['id']?>" style="color: red"><?= $anime['title'] ?></a>
                                    <p style="font-size: 12px;"><?= $anime['genre'] ?></p>
                                </div>
                            </div>
                        </td>
                        <td><?= $anime['episodes'] ?> / 12</td>
                        <td><?= $anime['type'] ?></td>
                        <td><?= $anime['studio'] ?></td>
                    </tr>
                    <? endforeach;?>
            ...
            <ul class="list-group" style="margin-left: 70px; width: 600px; height: 600px">
                <li class="list-group-item"><h5>Меню</h5></li>
                ...
                <a href="#" style="text-decoration: none"> <li class="list-group-item">Список аниме</li> </a>
